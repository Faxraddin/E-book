  ...
  return (
      <View style={{flex:1,justifyContent:'center',alignItems:'center',width:'100%'}}>
          <View style={{flex:1,width:'100%'}}>
            ...
            <View style={{height:'60%',backgroundColor:'white',width:'100%',justifyContent:'center',alignItems:'center',borderWidth:1,borderRadius:30,position:'relative',top:'-10%'}}>
              <View style={{width:'100%',flex:1,padding:40,gap:15}}>
                ...
                <TouchableOpacity onPress={handleClick} style={{backgroundColor:'#1a60e6',padding:15,borderW:1,borderRadius:20}}>
